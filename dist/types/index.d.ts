...
export type LeadSourceType = 'obituary_death_mining' | 'probate_intelligence' | 'code_violation_tracking' | 'tax_delinquency' | 'vacancy_detection' | 'divorce_records' | 'bankruptcy_filings' | 'pre_foreclosure' | 'notice_of_default' | 'absentee_owner' | 'expired_listings' | 'fsbo_tracking' | 'high_equity' | 'wholesale_leads';
